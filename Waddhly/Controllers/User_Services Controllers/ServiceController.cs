...
namespace Waddhly.Controllers
{
	...
	public class ServiceController : ControllerBase
	{
		...
		{
			var collofser = _context.Services.Include(s => s.category).Include(c => c.user).ToList();

			List<GetServiceDTO> services = new List<GetServiceDTO>();
			foreach (var item in collofser)
			{
				...
				s.service_user_id = item.user.Id;
		...
		public IActionResult GetServiceByid(int id)
		{
			...
			serviceDTO.service_user_id = service.user.Id;
